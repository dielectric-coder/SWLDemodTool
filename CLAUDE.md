...
SWL Demod Tool — TUI demodulator for the Elad FDM-DUO software-defined radio. Connects to an IQ sample server and CAT control server over TCP, demodulates AM/SSB/CW/DRM audio, and displays a live spectrum in the terminal using Textual.
