...
SWL Demod Tool — Terminal UI demodulator for the Elad FDM-DUO software-defined radio, built with Python and Textual. Connects to an IQ sample server and CAT control server over TCP, demodulates AM/SSB/CW/RTTY/PSK31/DRM audio, and displays a live spectrum.
